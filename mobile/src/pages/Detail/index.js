...
const Detail = () => {
  ...
  function handleComposeMail() {
    MailComposer.composerAsync({
      subject: 'Interesse na coleta de resiuos',
      recipients: [data.point.email]
    })
  }

  function handleWhattsapp() {
    Linking.openURL(`whattsapp://send?phone=${data.point.whattsapp}&text=Tenho interesse sobre coleta de residuos`)
  }
    ...
    <>
      ...
      <View style={styles.footer}>
        <RectButton style={styles.button} onPress={handleWhattsapp}>
          ...
          <Text style={styles.buttonText}>Whattsapp</Text>
        </RectButton>
